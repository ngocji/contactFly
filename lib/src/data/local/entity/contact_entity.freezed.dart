...
class _$ContactEntityImpl implements _ContactEntity {
  const _$ContactEntityImpl(
      {@JsonKey(name: Tables.CONTACT_COLUMN_NAME) this.name,
      @JsonKey(name: Tables.CONTACT_COLUMN_EMAIL) this.email,
      @JsonKey(name: Tables.CONTACT_COLUMN_CITY) this.city,
      @JsonKey(name: Tables.CONTACT_COLUMN_MAC) this.mac,
      @JsonKey(name: Tables.CONTACT_COLUMN_TIMESTAMP) this.timestamp,
      @JsonKey(name: Tables.CONTACT_COLUMN_CREDIT_CARD) this.creditcard});
...
abstract class _ContactEntity implements ContactEntity {
  const factory _ContactEntity(
      {@JsonKey(name: Tables.CONTACT_COLUMN_NAME) final String? name,
      @JsonKey(name: Tables.CONTACT_COLUMN_EMAIL) final String? email,
      @JsonKey(name: Tables.CONTACT_COLUMN_CITY) final String? city,
      @JsonKey(name: Tables.CONTACT_COLUMN_MAC) final String? mac,
      @JsonKey(name: Tables.CONTACT_COLUMN_TIMESTAMP) final String? timestamp,
      @JsonKey(name: Tables.CONTACT_COLUMN_CREDIT_CARD)
